...
import vman2002.vthreehx.Constants.TangentSpaceNormalMap;
...
class MeshStandardMaterial extends Material {
		 ...
		 * @default (1,1,1)
		 */
		public var color = new Color( 0xffffff ); // diffuse
		 ...
		 * @default (0,0,0)
		 */
		public var emissive = new Color( 0x000000 );
		 ...
		 * @default 1
		 */
		public var emissiveIntensity = 1.0;
		 ...
		 * @default (1,1)
		 */
		public var normalScale = new Vector2( 1, 1 );
		 ...
		 * @default null
		 */
		public var displacementMap = null;
		 ...
		 * @default 0
		 */
		public var displacementScale = 1;
		 ...
		 * @default 1
		 */
		public var envMapIntensity = 1.0;
